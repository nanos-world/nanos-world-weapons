...
NanosWorldWeapons = {
	AK47 = function(location, rotation)
		...
		weapon:SetLeftHandTransform(Vector(22, 0, 8), Rotator(0, 60, 90))
	...
	AK74U = function(location, rotation)
		...
		weapon:SetLeftHandTransform(Vector(26, 0, 8), Rotator(0, 60, 90))
		weapon:SetRightHandOffset(Vector(-10, 0, 0))
		weapon:SetHandlingMode(HandlingMode.DoubleHandedWeapon)
	...
	ASVal = function(location, rotation)
		...
		weapon:SetSightTransform(Vector(0, 0, -1), Rotator(-1.5, 0, 0))
		weapon:SetLeftHandTransform(Vector(23.5, 0, 8.5), Rotator(0, 60, 90))
	...
	GE3 = function(location, rotation)
		...
		weapon:SetLeftHandTransform(Vector(27.5, 0, 10), Rotator(0, 60, 90))
		weapon:SetRightHandOffset(Vector(-10, 0, 0))
		weapon:SetHandlingMode(HandlingMode.DoubleHandedWeapon)
	...
	AK5C = function(location, rotation)
		...
		weapon:SetLeftHandTransform(Vector(25, 0, 9), Rotator(0, 60, 90))
		weapon:SetRightHandOffset(Vector(-10, 0, 0))
		weapon:SetHandlingMode(HandlingMode.DoubleHandedWeapon)
		weapon:SetCadence(0.09)
		weapon:SetWallbangSettings(50, 0.5)
	...
	AWP = function(location, rotation)
		...
		weapon:SetLeftHandTransform(Vector(25, 0, 5), Rotator(0, 60, 90))
